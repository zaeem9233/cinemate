  ...
  return (
    <main>
      <section className='flex justify-around flex-wrap py-5'>
        ...
        <div className='max-w-2xl text-gray-700 text-lg dark:text-gray-100'>
          ...
          { movie.genres ? (
              <p className='my-7 flex flex-wrap gap-2'>
                { movie.genres.map((genre) => (
                  <span key={genre.id} className='mr-2 p-2 border rounded border-gray-200 dark:border-gray-600'>{ genre.name }</span>
                )) }
              </p>
            ) : "" }
          ...
          <div class="flex items-center">
            ...
            <p class="text-gray-900 dark:text-white">{ movie.vote_average }</p>
            <span class="w-1 h-1 mx-1.5 bg-gray-500 rounded-full dark:bg-gray-400"></span>
            <span href="#" class="text-gray-900 dark:text-white">{ movie.vote_count } reviews</span>
          </div>
